...
class _$_FeedDto extends _FeedDto {
  ...
  @override
  String toString() {
    return 'FeedDto(id: $id, type: $type, username: $username, userId: $userId, postId: $postId, userAvatarUrl: $userAvatarUrl, thumbnailUrl: $thumbnailUrl, serverTimestamp: $serverTimestamp)';
  }
